...
function About() {
  return (
    <div className="a-propos">
      ...
      <p>
        Uzima Events est une application de gestion d&apos;événements conçue
        pour vous aider à organiser et à gérer vos événements de manière simple
        et efficace. Que vous organisiez une conférence, un mariage, un festival
        ou un événement d&apos;entreprise, Uzima Events vous offre les outils
        dont vous avez besoin pour le réussir.
      </p>
      ...
      <p>
        ...
        d&apos;événements. Nous avons pour mission de vous offrir les outils les
        plus innovants et les plus performants pour vous aider à organiser des
